...
// Total jumlah data
$totalData = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM cat_kerja"));
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h3 class="page-title">Tabel Umpan Balik</h3>
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                         ...
                         <a class="btn btn-sm btn-primary" href="tambah_cat_kerja.php"><i class="mdi mdi-plus"></i> Tambah Data</a>
                         </div>
                    ...
                    <tbody>
                        <tr>
                             <td><?= $i; ?></td>
                             <td><?= $row["kode_perintah_kerja"]; ?></td>
                             <td><?= $row["teknisi"]; ?></td>
                             <td><?= $row["unit"]; ?></td>
                             <td><?= $row["lokasi"]; ?></td>
                             <td><?= $row["perbaikan_mesin"]; ?></td>
                             <td><?= $row["tgl_selesai"]; ?></td>
                             <td><?= $row["hasil_kerja"]; ?></td>
                             <td><?= $row["status_akhir"]; ?></td>
                            <td>
                                 <a href="edit_cat_kerja.php?id=<?= $row["id"]; ?>" class="btn btn-primary">edit</a>
                                 <a href="delete_cat_kerja.php?id=<?= $row["id"]; ?>" class="btn btn-info">hapus</a>
                          </td>
                        </tr>
                        <?php $i++;
                        } ?>
                ...
                <div align="right">
                    <ul class="pagination">
                     <?php if ($page > 1) : ?>
                     <li class="page-item">
                         <a class="page-link" href="data_cat_kerja.php?Kolom=<?php echo $kolomCari; ?>&KataKunci=<?php echo $kolomKataKunci; ?>&page=1">First</a>
                     </li>

                     <li class="page-item">
                         <a class="page-link" href="data_cat_kerja.php?Kolom=<?php echo $kolomCari; ?>&KataKunci=<?php echo $kolomKataKunci; ?>&page=<?php echo $page - 1; ?>">Previous</a>
                     </li>
                 ...
                 <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                     <li class="page-item <?php if ($page === $i) echo 'active'; ?>">
                         <a class="page-link" href="data_cat_kerja.php?Kolom=<?php echo $kolomCari; ?>&KataKunci=<?php echo $kolomKataKunci; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                     </li>
                ...
                <?php endfor; ?>
                 ...
                 <?php if ($page < $totalPages) : ?>
                     <li class="page-item">
                         <a class="page-link" href="data_cat_kerja.php?Kolom=<?php echo $kolomCari; ?>&KataKunci=<?php echo $kolomKataKunci; ?>&page=<?php echo $page + 1; ?>">Next</a>
                     </li>
                     <li class="page-item">
                         <a class="page-link" href="data_cat_kerja.php?Kolom=<?php echo $kolomCari; ?>&KataKunci=<?php echo $kolomKataKunci; ?>&page=<?php echo $totalPages; ?>">Last</a>
                     </li>
                 <?php endif; ?>
                     </ul>
                </div>
