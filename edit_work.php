<?php
    ...
    function edit($data) {
        ...
        $kondisi_mesin_last =  htmlspecialchars($data['kondisi_mesin_last']);
		 ...
		 $query = "UPDATE work_order SET 
		 					kode_work_order = '$kode_work_order',
							teknisi = '$teknisi',
							tgl_mulai = '$tgl_mulai',
							tgl_selesai = '$tgl_selesai',
							masalah_mesin = '$masalah_mesin', 
                            status = '$status',
                            kondisi_mesin_last = '$kondisi_mesin_last'
							WHERE id = $id
							";
    ...
    $work = query("SELECT * FROM work_order WHERE id = $id")[0];
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h3 class="page-title">Form Edit Perintah Kerja</h3>
          ...
          <!-- ============================================================== -->
            <div class="row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="kode_work_order" name="kode_work_order" style="font-weight:bold;" required value="<?= $work["kode_work_order"];?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-3 col-form-label" style="font-weight:bold;  color: black;">Teknisi</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="teknisi" value="<?= $work["teknisi"];?>" name="teknisi" style="font-weight:bold;" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-3 col-form-label" style="font-weight:bold;  color: black;">Start Date</label>
                    <div class="col-sm-8">
                    <input type="date" class="form-control" id="tgl_mulai" value="<?= $work["tgl_mulai"];?>" name="tgl_mulai"style="font-weight:bold;" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-3 col-form-label" style="font-weight:bold;  color: black;">Target Date</label>
                    <div class="col-sm-8">
                    <input type="date" class="form-control" id="tgl_selesai" value="<?= $work["tgl_selesai"];?>" name="tgl_selesai" style="font-weight:bold;" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-3 col-form-label" style="font-weight:bold;  color: black;">Masalah Mesin</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="masalah_mesin"  value="<?= $work["masalah_mesin"];?>" name="masalah_mesin" style="font-weight:bold;" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-3 col-form-label" style="font-weight:bold;  color: black;">Status</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="status" value="<?= $work["status"];?>" name="status" style="font-weight:bold;" required> 
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-3 col-form-label" style="font-weight:bold;  color: black;" >Level Kerusakan </label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control" id="kondisi_mesin_last" value="<?= $work["kondisi_mesin_last"];?>" name="kondisi_mesin_last" style="font-weight:bold;" required> 
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-5">
