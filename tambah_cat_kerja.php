    ...
    if(isset($_POST['simpan'])) {
        ...
        function tambah($data) {
            ...
            $status_akhir =  htmlspecialchars($data['status_akhir']);
             ...
             $query = "INSERT INTO cat_kerja VALUES ('','$kode_perintah_kerja', '$teknisi', '$unit', '$lokasi' , '$perbaikan_mesin', '$tgl_selesai', '$hasil_kerja', '$status_akhir')";
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h3 class="page-title">Form Tambah Umpan Balik</h3>
          ...
          <!-- ============================================================== -->
            <div class="row">
                ...
                <div class="card" style="background-color: azure;">
                    ...
                    <form method="POST" action="tambah_cat_kerja.php">
                    <div class="form-group row">
                        <label for="inputEmail3" style="font-weight:bold; color: black;" class="col-sm-3 col-form-label">Kode Perintah Kerja</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="kode_perintah_kerja" name="kode_perintah_kerja" style="font-weight:bold;" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword3" style="font-weight:bold; color: black;" class="col-sm-3 col-form-label" >Nama Teknisi</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="teknisi" name="teknisi" style="font-weight:bold;" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword3" style="font-weight:bold; color: black;" class="col-sm-3 col-form-label" >Nama Unit Induk</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="unit" name="unit" style="font-weight:bold;" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword3" style="font-weight:bold; color: black;" class="col-sm-3 col-form-label" >Lokasi</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="lokasi" name="lokasi" style="font-weight:bold;" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword3" style="font-weight:bold; color: black;" class="col-sm-3 col-form-label" >Perbaikan pada Mesin</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="perbaikan_mesin" name="perbaikan_mesin" style="font-weight:bold;" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword3" style="font-weight:bold; color: black;" class="col-sm-3 col-form-label" >Tanggal Selesai</label>
                        <div class="col-sm-8">
                        <input type="date" class="form-control" id="tgl_selesai" name="tgl_selesai" style="font-weight:bold;" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword3" style="font-weight:bold; color: black;" class="col-sm-3 col-form-label" >Hasil Kerja</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="hasil_kerja" name="hasil_kerja" style="font-weight:bold;" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword3" style="font-weight:bold; color: black;" class="col-sm-3 col-form-label" >Status Akhir</label>
                        <div class="col-sm-8">
                        <input type="text" class="form-control" id="status_akhir" name="status_akhir" style="font-weight:bold;" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-5">
